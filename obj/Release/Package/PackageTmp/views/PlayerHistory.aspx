...
<body>
    ...
    <div class="bs-docs-header" id="content">
        <div class="container">
            <h1 id="lan_PlayerHistory_title" data-lan-id="PlayerHistory_title"></h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-4" for="server_list" id="lan_PlayerHistory_server_list" data-lan-id="PlayerHistory_server_list">서버</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4" for="type_select" id="lan_PlayerHistory_type" data-lan-id="PlayerHistory_type"></label>
                        <div class="col-sm-8">
                            <select id="type_select" class="col-sm-6 form-control">
                                <option value="0" id="lan_PlayerHistory_type0" data-lan-id="PlayerHistory_type0"></option>
                                <option value="1" id="lan_PlayerHistory_type1" data-lan-id="PlayerHistory_type1"></option>
                                <option value="2">HeroInfo Journal</option>
                            </select>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-4" for="player_id" id="lan_PlayerHistory_palyer_id" data-lan-id="PlayerHistory_palyer_id"></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4" for="datetimepicker_1" id="lan_PlayerHistory_start_time" data-lan-id="PlayerHistory_start_time"></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4" for="datetimepicker_2" id="lan_PlayerHistory_end_time" data-lan-id="PlayerHistory_end_time"></label>
                        <div class="col-sm-8">
                            <input class="form-control" size="25" type="text" placeholder="lan_PlayerHistory_end_time_input_tip" value="" id="datetimepicker_2" runat="server" name="datetimepicker_2" data-lan-id="PlayerHistory_end_time_input_tip" data-lan-type="placeholder" />
                        </div>
                    </div>
