...
<body>
    ...
    <div class="bs-docs-header" id="content">
        <div class="container">
             <h1 id="titleTip" data-lan-id="ServerData"></h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
                <h1 class="page-header" id="lan_ServerData" data-lan-id="ServerData"></h1>
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-4" for="input_channel" id="lan_ServerData_channel" data-lan-id="ServerData_channel"></label>
                        <div class="col-sm-8">
                            <input class="form-control" type="number" placeholder="" value="" id="input_channel" data-lan-id="ServerData_channel_placeholder" data-lan-type="placeholder" disabled/>
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function queryServerData() {
        var jsonData = { "channel_id": $('#input_channel').val(), "date_start": $('#datetimepicker_1').val(), "date_end": $('#datetimepicker_2').val() };
        $.ajax(
        {
            type: "POST",
