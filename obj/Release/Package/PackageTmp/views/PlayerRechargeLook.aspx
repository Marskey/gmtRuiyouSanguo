        ...
        <div class="row">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-4" id="uidTip" runat="server"></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4" id="start_time_tip" runat="server"></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4" id="end_time_tip" runat="server"></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4" id="totalCostTip" runat="server"></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4" id="playerCntTip" runat="server"></label>
