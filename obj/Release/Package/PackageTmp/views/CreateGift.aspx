        ...
        <div class="row">
                <form id="form1" runat="server">
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="typeTipLabel" runat="server"></asp:Label></td>
                            <td>
                            ...
                            <td colspan="2">
                                <asp:Label ID="typeLabel" runat="server" Font-Bold="true" ForeColor="#006600" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="giftSelectTipLabel" runat="server"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="useTimesTipLabel" runat="server"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="createButton" runat="server" Text="" OnClick="createButton_Click" UseSubmitBehavior="False" ForeColor="White" BackColor="Blue" Width="100" Height="30" Font-Bold="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>
