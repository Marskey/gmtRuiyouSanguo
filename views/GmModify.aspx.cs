    ...
    public partial class GmModify : AGmPage
    {
        ...
        protected void stopButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in this.selectListBox.Items)
            {
                ...
                if (server != null)
                {
                    AGmPage.ExecuteGmCommand(account,
                                          server,
                                          "0",
                                          "SIPC(1)",
                                          "",
        ...
        protected void whiteListButton_Click(object sender, EventArgs e)
        {
            ...
            if (partSet.Length != 4)
            {
                this.errorLabel.Text += TableManager.GetGMTText(735) + "\r\n";
                return;
            }
            ...
            for (int i = 0; i < selectListBox.Items.Count; ++i)
            {
                ...
                AGmPage.ExecuteGmCommand(account, server, "0", string.Format("SIP(\"{0}\")", this.whileListTextBox.Text), "", true, text => this.errorLabel.Text += text);
            }
        }
        ...
        protected void fcOpenButton_Click(object sender, EventArgs e)
        {
            if (this.selectListBox.Items.Count == 0)
            {
                this.errorLabel.Text = TableManager.GetGMTText(734);
        ...
        protected void fcCloseButton_Click(object sender, EventArgs e)
        {
            if (this.selectListBox.Items.Count == 0)
            {
                this.errorLabel.Text = TableManager.GetGMTText(734);
        ...
        protected void CICButton_Click(object sender, EventArgs e)
        {
            if (this.selectListBox.Items.Count == 0)
            {
                this.errorLabel.Text = TableManager.GetGMTText(734);
        ...
        protected void allowRegisterButton_Click(object sender, EventArgs e)
        {
            if (this.selectListBox.Items.Count == 0)
            {
                this.errorLabel.Text = TableManager.GetGMTText(734);
        ...
        protected void stopRegisterButton_Click(object sender, EventArgs e)
        {
            if (this.selectListBox.Items.Count == 0)
            {
                this.errorLabel.Text = TableManager.GetGMTText(734);
