                ...
                <form id="form1" runat="server">
                    <div>
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Button data-lan-id="Save" data-lan-type="text" runat="server" Text="" OnClick="saveButton_Click" ForeColor="White" BackColor="Blue" Width="81px" Height="30px" Font-Bold="true" />
                                </td>
                            </tr>
                        </table>
                    </div>
