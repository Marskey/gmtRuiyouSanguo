...
<body>
    ...
    <div class="bs-docs-header" id="content">
        <div class="container">
            <h1 data-lan-id="PayType"></h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
                <h1 class="page-header" data-lan-id="PayType"></h1>
                <div id="toolbar">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table_td_200">
                                <tr>
                                    <td>
                                        <label data-lan-id="PayType_input_pkg_name"></label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <label data-lan-id="PayType_Name"></label>
                                    </td>
                                    <td>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" onclick="setPayType();" data-dismiss="modal" data-lan-id="PayType_Confirm"></button>
                            <button type="button" class="btn btn-default" data-dismiss="modal" data-lan-id="PayType_Cancel"></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function operateEvents(opt, row) {
        ...
        if (opt == 1) {
            ...
            $('#lan_PayType_Modify').html(GetContentMsg("Confirm_delete"));
        }
